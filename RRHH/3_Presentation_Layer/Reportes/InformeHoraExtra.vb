...
Public Class InformeHoraExtra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RRHH.InformeHoraExtra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInformeHoraExtra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InformeHoraExtra = New InformeHoraExtra()
        rpt.Site = Me.Site
        Return rpt
    End Function
