...
Public Class InformePermisos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RRHH.InformePermisos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInformePermisos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InformePermisos = New InformePermisos()
        rpt.Site = Me.Site
        Return rpt
    End Function
