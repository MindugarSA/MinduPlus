Public Class Frm_SeleccionGestionAlmuerzos
    ...
    Private Sub MetroTile1_MouseEnter(sender As Object, e As EventArgs) Handles Tle_MantencionColacione.MouseEnter, Tle_Configuracion.MouseEnter, Tle_AlmuAdicional.MouseEnter
    ...
    Private Sub MetroTile1_MouseLeave(sender As Object, e As EventArgs) Handles Tle_MantencionColacione.MouseLeave, Tle_Configuracion.MouseLeave, Tle_AlmuAdicional.MouseLeave
        sender.Left = sender.Left + 4
        sender.Top = sender.Top + 4
        sender.Height = sender.Height - 8
        sender.Width = sender.Width - 8
