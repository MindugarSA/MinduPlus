...
Public Class InformePermiso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RRHH.InformePermiso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInformePermiso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InformePermiso = New InformePermiso()
        rpt.Site = Me.Site
        Return rpt
    End Function
